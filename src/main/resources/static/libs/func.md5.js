/**
 * JS的MD5加密算法:基于jQuery进行封装 <br>
 * A JavaScript implementation of the RSA Data Security, Inc. MD5 Message Digest
 * Algorithm, as defined in RFC 1321. <br>
 * Version 2.2 Copyright (C) Paul Johnston 1999 - 2009<br>
...
(function($) {
	$.Md5 = function() {
		this.settings = $.extend(true, {}, $.Md5.defaults);
	};

	$.extend($.Md5, {
		/**
		 * Configurable variables. You may need to tweak these
		 * to be compatible with the server-side, but the
		...
		prototype : {
			...
			/**
			 * These are the functions you'll usually want to
			 * call They take string arguments and return either
			 * hex or base-64 encoded strings
			 */
			hex_md5 : function(s) {
				var _this = this;
				return _this.rstr2hex(_this.rstr_md5(_this.str2rstr_utf8(s)));
			},
			b64_md5 : function(s) {
				var _this = this;
				return _this.rstr2b64(_this.rstr_md5(_this.str2rstr_utf8(s)));
			},
			any_md5 : function(s, e) {
				var _this = this;
				return _this.rstr2any(_this.rstr_md5(_this.str2rstr_utf8(s)), e);
			},
			hex_hmac_md5 : function(k, d) {
				var _this = this;
				return _this.rstr2hex(_this.rstr_hmac_md5(_this.str2rstr_utf8(k), _this.str2rstr_utf8(d)));
			},
			b64_hmac_md5 : function(k, d) {
				var _this = this;
				return _this.rstr2b64(_this.rstr_hmac_md5(_this.str2rstr_utf8(k), _this.str2rstr_utf8(d)));
			},
			any_hmac_md5 : function(k, d, e) {
				var _this = this;
				return _this.rstr2any(_this.rstr_hmac_md5(_this.str2rstr_utf8(k), _this.str2rstr_utf8(d)), e);
			},
			/**
			...
			md5_vm_test : function() {
				var _this = this;
				return _this.hex_md5("abc").toLowerCase() == "900150983cd24fb0d6963f7d28e17f72";
			},
			/**
			 * Convert a raw string to a hex string
			 */
			rstr2hex : function(/* String */input) {
				var _this = this;
				try {
					_this.settings.hexcase;
				} catch (e) {
					_this.settings.hexcase = 0;
				}
				var hex_tab = _this.settings.hexcase ? "0123456789ABCDEF" : "0123456789abcdef";
				var output = "";
				var x;
			 ...
			 */
			rstr2b64 : function(/* String */input) {
				var _this = this;
				try {
					_this.settings.b64pad;
				} catch (e) {
					_this.settings.b64pad = '';
				}
			...
			/**
			 * Convert a raw string to an arbitrary string
			 * encoding
			 */
			rstr2any : function(input, encoding) {
				...
				/**
				 * Repeatedly perform a long division. The binary array forms the dividend, the
				 * length of the encoding is the divisor. Once computed, the quotient forms the
				 * dividend for the next step. All remainders are stored for later use.
				 */
			 ...
			 */
			str2rstr_utf8 : function(/* String */input) {
				var output = "";
				var i = -1;
				var x, y;
			 ...
			 */
			str2rstr_utf16le : function(/* String */input) {
				var output = "";
				for ( var i = 0; i < input.length; i++) {
					output += String.fromCharCode(
			...
			str2rstr_utf16be : function(/* String */input) {
				var output = "";
				for ( var i = 0; i < input.length; i++) {
					output += String.fromCharCode(
							(input.charCodeAt(i) >>> 8) & 0xFF, 
			 ...
			 */
			rstr2binl : function(/* String */input) {
			 ...
			 */
			binl2rstr : function(/* String */input) {
				var output = "";
			 ...
			 */
			binl_md5 : function(/* String */x, /* int */len) {
				var _this = this;
				/* append padding */
				x[len >> 5] |= 0x80 << ((len) % 32);
				x[(((len + 64) >>> 9) << 4) + 14] = len;
			...
			rstr_hmac_md5 : function(key, data) {
				var _this = this;
				var bkey = _this.rstr2binl(key);
				if (bkey.length > 16) {
					bkey = _this.binl_md5(bkey, key.length * 8);
				}
				...
				var hash = _this.binl_md5(ipad.concat(_this.rstr2binl(data)), 512 + data.length * 8);
				return _this.binl2rstr(_this.binl_md5(opad.concat(hash), 512 + 128));
			},
			/**
			 * Calculate the MD5 of a raw string
			 */
			rstr_md5 : function(/* String */input) {
				var _this = this;
				return _this.binl2rstr(_this.binl_md5(_this.rstr2binl(input), input.length * 8));
			}
		}
	});
})(jQuery);